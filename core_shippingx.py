    ...
    while(count < 3):
        ...
        if subprocess.call(['ping', param, '1', site['ip_address']]) == 0:
            ...
            for recipient in recipients:
                msg = "Hi there,\n\nDeployment of CORE to v5.0.5-beta for " + site['name'] + " completed succesfully.\n\nThanks!\nEGPAF HIS."
                params = {
            ...
            if count == 3:
                for recipient in recipients:
                    msg = "Hi there,\n\nDeployment of CORE to v5.0.5-beta for " + site['name'] + " failed to complete after several connection attempts.\n\nThanks!\nEGPAF HIS."
                    params = {
                        "api_key": os.getenv('API_KEY'),
                        "recipient": recipient,
                        "message": msg
